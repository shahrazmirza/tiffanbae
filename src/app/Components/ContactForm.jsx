    ...
    <Container>
      <div className='flex flex-col-reverse md:flex md:flex-row w-full px-10 pt-10'>
        <div className='flex flex-col md:w-2/4 pr-24'>
          <p className='text-2xl/loose font-normal text-gray-700 font-heading2'>GET IN TOUCH</p>
          <p className='text-base/loose font-normal text-gray-700 pt-5'>If you have any questions, please feel free to contact us. We will love to answer all your queries.</p>
          <p className='text-2xl/loose font-normal text-gray-700 font-heading2 pt-5'>CALL US</p>
          <div className='flex items-center pt-5'>
            <div className='text-gray-700 leading-10 pr-1'>
              <MdLocalPhone />
            </div>
            <p className='text-base/loose font-normal text-gray-700'>0487 547 743</p>
          </div>
