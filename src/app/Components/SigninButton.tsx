      ...
      {session && session.user ? (
        <>
          <div className="flex flex-col justify-center items-center">
            <Link href="/Cart">
              <p className="px-6 text-orange-400 font-medium text-sm z-20 ml-1 mb-4">
                {totalQuantity || 0}
              </p>
            </Link>

            <Link href="/Cart" className="px-6 text-2xl absolute text-white">
              <Image src="/assets/Cart.png" alt="" width="35" height="30" />
            </Link>
          </div>
          ...
          >
            <DropdownTrigger>
              <MyButton disableRipple>
                G'Day
                <p className="font-medium text-base text-orange-400">
